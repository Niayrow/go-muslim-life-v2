...
const PAGES: SearchEntry[] = [
  ...
  },
  {
    ...
    icon: Settings,
    category: "page",
    keywords: "confidentialité privacy rgpd données vie privée",
  },
  {
    id: "sources",
    title: "Sources & crédits",
    subtitle: "Licences et références",
    href: "/sources",
    icon: BookOpen,
    category: "page",
    keywords: "sources crédits licences coran aladhan quran",
  },
  {
    id: "conditions",
    title: "Conditions d’utilisation",
    subtitle: "Règles du service",
    href: "/conditions",
    icon: Settings,
    category: "page",
    keywords: "conditions cgu utilisation termes légal",
  },
  {
    id: "histoires",
